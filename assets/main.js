...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.container.style2', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 1000, intensity: 9, delay: 500, staggerOrder: '', replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-up', speed: 750, intensity: 3, delay: 0, staggerOrder: '', replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-in', speed: 1000, intensity: 9, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-down', speed: 750, intensity: 1, delay: 0, stagger: 125, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-down', speed: 750, intensity: 1, delay: 125, staggerOrder: '', replay: false });
		...
		onvisible.add('.list.style1', { style: 'fade-in', speed: 1000, intensity: 9, delay: 125, stagger: 125, replay: false });
